      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800/80 pb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white tracking-tight">Departments Summary</h3>
              <p className="text-xs text-slate-400">Company department structure & headcount</p>
            </div>
          </div>
        ...
        {deptList.length === 0 ? (
          <div className="py-8 text-center space-y-2">
            ...
            <p className="text-[11px] text-slate-500">Create departments to categorize your company workforce.</p>
          </div>
        ) : (
              ...
              return (
                <div key={dept.name} className="space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-slate-400 font-medium">{dept.count} {dept.count === 1 ? "member" : "members"}</span>
                      <span className="text-slate-500 font-mono text-[11px]">({dept.percentage}%)</span>
                    </div>
                  </div>
      ...
      {onManageDepartments && (
        <div className="pt-2">
          <button
            ...
            className="w-full py-2.5 rounded-xl bg-sky-600/20 hover:bg-sky-600/30 text-sky-300 border border-sky-500/30 text-xs font-semibold transition flex items-center justify-center space-x-2"
          >
