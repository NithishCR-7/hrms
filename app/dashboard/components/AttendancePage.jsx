                    ...
                    {isOnBreak ? (
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <button
                          ...
                          className="py-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold transition shadow-xl flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          disabled={actionLoading}
                          className="py-4 rounded-xl border border-rose-500/40 bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 text-sm font-bold transition shadow-xl flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                        >
                          <span className="text-base">⏹</span>
                          <span>Check Out</span>
                        </button>
